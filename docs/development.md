...
当前版本为 `0.3.0`，对应可选本地搜索与评论插槽；`0.2.0` 为阅读体验增强，`0.1.0` 为首个 MVP。此前 `0.2.5` 沿用自上游，不表示本项目已完成 PRD 的 0.2 阶段。版本与破坏性变更记录在 [CHANGELOG](../CHANGELOG.md)。`package.json` 版本也用于 JS/CSS URL 的缓存参数，修改后需重新生成示例站。
