...
当前示例页头及四篇文章封面使用本地 WebP 副本；原始 JPG 和历史正文中的引用保留，便于再生成与迁移回归。使用系统 `cwebp`（本次 1.3.2）运行 `node toolbox/optimize-example-images.mjs`，按质量 78、method 6 生成以下文件，不裁剪、不放大：

| 图片 | 用途 | 原图尺寸 | WebP 尺寸 |
| --- | --- | --- | --- |
| wallpaper-878514 | 页头 / 横幅封面 | 3840 × 1200 | 1920 × 600 |
| wallpaper-2311325 | 置顶文章封面 | 1383 × 1858 | 800 × 1075 |
