...
export async function syncExampleDocs() {
  ...
  const entries = [['index', 'Syutoi 文档中心', '从安装到发布，按顺序开始使用书台。'], ...documents];
  for (const [slug, title, description] of entries) {
    ...
    const data = {title, description, date:'2026-09-22 00:00:00', updated:'2026-09-22 00:00:00', comments:false};
