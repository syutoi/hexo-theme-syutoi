...
const paths = ['/', '/markdown-extensions/', '/welcome/', '/archives/', '/categories/', '/categories/writing/', '/tags/', '/tags/写作/', '/friends/', '/404.html', '/examples/', '/examples/empty/', '/examples/english/', '/syutoi-long-read/', '/syutoi-minimal/', '/syutoi-boundaries/', '/no-title/', '/reading/', '/typography/', '/reading-elements/', '/code/', '/pictures/'];
